...
export function FacebookPreview() {
  ...
  const titleLimit = checkCharacterLimit(title, "facebook", "title");
  const descLimit = checkCharacterLimit(description, "facebook", "description");

  return (
    <div className="bg-white dark:bg-zinc-900 rounded-lg border overflow-hidden max-w-[500px]">
      {/* Image */}
      ...
      {/* Content */}
      <div className="p-3 bg-[#f2f3f5] dark:bg-zinc-800 border-t border-gray-300 dark:border-zinc-700">
